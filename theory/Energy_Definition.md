...
1.  **Logical Validity**: A binary judgment (Valid/Invalid).
2.  **VAPO Guidance**: A continuous gradient-like signal for optimization.
...
impl EnergySignal {
    /// Additive aggregation for sequential steps
    fn aggregate_sequential(&self, other: &Self) -> Self { 
        // Implementation of gamma-discounted sum
    } 

    /// Max-based aggregation for logical branching
    fn aggregate_logical(&self, other: &Self) -> Self {
        // Implementation of Ultrametric Max
    }
}
```
