...
**Impact:** The system no longer requires running massive LLMs for real-time inference (except as an optional "intuitive" guide). The generation process is constrained within a rigorous algebraic group structure ("Algebraic Soundness"), while semantic correctness is achieved through VAPO's energy minimization. This shifts the paradigm from "Correct-by-Construction" to "Verified-by-Search."
